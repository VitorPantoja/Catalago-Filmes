...
public class CategoriaController {
    ...
    public ResponseEntity<?> findAll(){
        try {
            ...
            if (categorias.isEmpty()){
                return new ResponseEntity<String>("Erro, sem categorias cadastradas", HttpStatus.NOT_FOUND);
            }
    ...
    public ResponseEntity<?> updateCategoria(@RequestBody @Validated Categoria obj){
        try {
            ...
            Categoria atualizaCategoria = categoriaService.update(obj);
            return ResponseEntity.ok().body(atualizaCategoria);
        } catch (Exception e){
    ...
    public ResponseEntity<?> salvaCategoria(@RequestBody @Validated Categoria categoria){
        try {
            Categoria salvaCategoria = categoriaService.save(categoria);
            return ResponseEntity.ok().body(salvaCategoria);
        }catch (Exception e){
